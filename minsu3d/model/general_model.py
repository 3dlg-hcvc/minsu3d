...
class GeneralModel(pl.LightningModule):
    ...
    def on_validation_epoch_end(self):
        ...
        if self.current_epoch > self.hparams.cfg.model.network.prepare_epochs:
            ...
            self.log("val_eval/AP", inst_seg_eval_result["all_ap"])
            self.log("val_eval/AP 50%", inst_seg_eval_result['all_ap_50%'])
            self.log("val_eval/AP 25%", inst_seg_eval_result["all_ap_25%"])
