...
std::tuple<at::Tensor, at::Tensor, at::Tensor> sg_bfs_cluster(at::Tensor class_numpoint_mean_tensor, at::Tensor ball_query_idxs_tensor, at::Tensor start_len_tensor, const int N, float threshold, const int class_id);
