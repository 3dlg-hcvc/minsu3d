...
__global__ void get_iou_cuda_(int nInstance, int nProposal, int *proposals_idx, int *proposals_offset, int *instance_labels, int *instance_pointnum, float *proposals_iou){
