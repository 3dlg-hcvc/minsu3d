...
if __name__ == '__main__':
    ...
    parser.add_argument('-t', '--task', type=str, default='', help='specify task: semantic | instance | alignment', required=True)
    ...
    if args.task == 'semantic':
        ...
        evaluate_func = getattr(import_module('lib.evaluation'), 'evaluate_alignment')
