...
class ScannetDatasetConfig(object):
    def __init__(self, cfg):
        ...
        self.mean_size_arr = np.load(os.path.join(cfg.SCANNETV2_PATH.meta_data, 'scannet_reference_means.npz'))['arr_0']
    ...
    def _get_nyu40id2class(self):
        lines = [line.rstrip() for line in open(os.path.join(self.cfg.SCANNETV2_PATH.meta_data, "scannetv2-labels.combined.tsv"))]
        lines = lines[1:]
        nyu40ids2class = {}
