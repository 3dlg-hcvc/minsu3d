...
data_dir="/local-scratch/qiruiw/dataset/scannet/splited_scans"
...
output_dir="/project/3dlg-hcvc/dense-scanrefer/www/scannet/sem_seg/gt_sem_label"
...
parallel -j $n --eta "CUDA_VISIBLE_DEVICES=0 $script \
    --input $data_dir/$split/{1}/{1}_vh_clean_2.labels.ply \
